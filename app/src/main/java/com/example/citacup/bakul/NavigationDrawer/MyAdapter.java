package com.example.citacup.bakul.NavigationDrawer;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(
            String Titles[], int Icons[], String Name, String Email, int Profile,
            MyActivity passedContext) {
        //have seen earlier
        mNavTitles = Titles;
        mIcons = Icons;
        name = Name;
    ...
    public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            ViewHolder vhItem = new ViewHolder(v, viewType,
                    context); //Creating ViewHolder and passing the object of type view
            ...
            View v = LayoutInflater.from(parent.getContext())
                                   .inflate(R.layout.header, parent, false); //Inflating the layout
    ...
    public void onBindViewHolder(MyAdapter.ViewHolder holder, int position) {
        if (holder.Holderid ==
                1) {                              // as the list view is going to be called after the header view so we decrement the
    ...
    public int getItemCount() {
        return mNavTitles.length +
                1; // the number of items in the list will be +1 the titles including the header view.
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, int ViewType, MyActivity c) {
            // Creating ViewHolder Constructor with View and viewType As a parameter
            super(itemView);
            contxt = c;
            itemView.setClickable(true);
            itemView.setOnClickListener(this);
            // Here we set the appropriate view in accordance with the the
            // view type as passed when the holder object is created
        ...
        public void onClick(View v) {
            ...
            contxt.onNavigationDrawerItemSelected(getPosition());
            contxt.onSectionAttached(getPosition());
            //contxt.restoreActionBar();
        }
