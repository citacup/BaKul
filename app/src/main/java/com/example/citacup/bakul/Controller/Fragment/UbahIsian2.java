 ...
 */
public class UbahIsian2 extends Fragment {
    ...
    public View onCreateView(
        ...
        rootview = inflater.inflate(R.layout.ubahisian2, container, false);
        ...
        listMatakuliah.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (MyActivity.databaseHelper
                        .cekValidLulus(selectedSimpan.getSks(), MyActivity.semesterOlah2) &&
                        MyActivity.databaseHelper.getLulusMatkul(selectedSimpan.getNama()) == 0) {
                    MyActivity.databaseHelper.setLulus(selectedSimpan.getNama());
                    MyActivity.databaseHelper
                            .setSemLulus(selectedSimpan.getNama(), MyActivity.semesterOlah2);
                ...
                ArrayList matkulLulus = MyActivity.databaseHelper
                        .getMatkulLulus2(MyActivity.semesterOlah2);
...
//////////////////////////////////UNTUK NGAPUS/////////////////////////////////////////////////////
        ...
        listlulus = (ListView) rootview.findViewById(R.id.listlulus);
        ArrayList matkulLulus = MyActivity.databaseHelper.getMatkulLulus2(MyActivity.semesterOlah2);
        Collections.sort(matkulLulus);
        ArrayAdapter<String> files2 = new ArrayAdapter<String>(getActivity(),
                android.R.layout.simple_list_item_1,
                matkulLulus);
        ...
        listlulus.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                MyActivity.databaseHelper
                        .setTidakLulus(
                                MyActivity.databaseHelper.getMatkulLulus2(MyActivity.semesterOlah2)
                                                         .get(position));
